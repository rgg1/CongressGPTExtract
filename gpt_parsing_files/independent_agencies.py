...
class agencies_json_schema(BaseModel):
    agencies: list[Agency]

def extract_independent_agencies_info(text_chunk, client):
    """
        ...
        response = client.chat.completions.create(
            ...
            response_format={
                ...
                'json_schema': 
                    {
                        "name":"_", 
                        "schema": agencies_json_schema.model_json_schema()
                    }
            },  
            temperature=0.3,
            # max_tokens=10000,
...
def process_independent_agency_file(file_name, input_dir, output_dir, client):
    # Read file content
...
def process_independent_agency_file_for_congress(congress_num, client, base_directory):
...
if __name__ == "__main__":
    ...
    # process_independent_agency_file('CDIR-2022-10-26-INDEPENDENTAGENCIES.txt', 'congressional_directory_files/congress_117/txt', 'outputs/117')
    process_independent_agency_file_for_congress(117)
